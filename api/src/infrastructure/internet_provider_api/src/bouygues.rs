...
pub struct BboxInternetProviderApi {
...
impl BboxInternetProviderApi {
    pub async fn new(base_url: Url, password: String) -> BboxInternetProviderApi {
        let api = BboxInternetProviderApi {
...
impl InternetProviderApi for BboxInternetProviderApi {
